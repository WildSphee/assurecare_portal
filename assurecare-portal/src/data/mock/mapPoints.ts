...
export const STATIC_MAP_POINTS: StaticMapPoint[] = [
  ...
  { id: 'map-point-004', patientId: 'patient-002', displayName: 'Daniel Lim', location: { lat: 1.3586, lng: 103.8224 } },
  { id: 'map-point-005', patientId: 'patient-002', displayName: 'Sarah Lee', location: { lat: 1.3661, lng: 103.8328 } },
