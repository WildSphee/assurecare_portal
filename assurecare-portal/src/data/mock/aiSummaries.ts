...
export const MOCK_AI_SUMMARIES: AISummary[] = [
  // Ms. Tan — Daily summary
  {
    ...
    summaryType: 'daily',
    narrative:
      'Ms. Tan completed her check-in this morning at 09:05. Her blood pressure has been gradually increasing over the past 10 days, now measuring 148/92 mmHg — higher than her usual range. She missed her evening medication on both Feb 23 and Feb 24, which may be contributing to the rise. A moderate episode of dizziness was reported yesterday. Morning medication adherence remains consistent. No emergency symptoms were reported today.',
    highlights: [
    ...
    suggestedActions: [
      ...
      'If dizziness continues or BP stays elevated, consider booking a clinic visit',
    ],
    confidence: 'high',
