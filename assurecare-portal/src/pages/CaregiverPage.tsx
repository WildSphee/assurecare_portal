  ...
  return (
    <>
      ...
      <div className="w-full px-3 sm:px-4 lg:px-5 py-5 sm:py-6">
        <div className="grid grid-cols-1 2xl:grid-cols-[480px_minmax(0,1fr)_360px] xl:grid-cols-[440px_minmax(0,1fr)_340px] gap-4 items-start">
          <aside className="min-w-0 xl:sticky xl:top-20">
            <div className="rounded-2xl border border-slate-300 bg-white p-4 shadow-sm xl:min-h-[calc(100vh-6rem)] xl:rounded-none xl:border-y-0 xl:border-l-0 xl:border-r xl:bg-white xl:shadow-none">
              <div className="min-w-0 space-y-0 divide-y divide-slate-200/80">
                ...
                <section id="risk" className="min-w-0 pt-4">
                  {latestAlert ? (
                    <RiskBanner
                ...
                <section id="ai-summary" className="min-w-0 pt-4">
                  {dailySummary ? (
                    <AISummary
